...
if (!isset($_SESSION['num_assessments']) || $_SESSION['num_assessments'] === null ||
    !isset($_SESSION['num_assignments']) || $_SESSION['num_assignments'] === null) {
...
$num_assignments = $_SESSION['num_assessments']; 
